...
window.CGA_MANIFEST = [
 ...
 },
 {
  ...
  "title": "Found the instance — the founding loop",
  "module": "system",
  "interactionClass": "all",
  "journeys": [],
  "reusesV1": [],
  ...
  "status": "built-layer",
  "stage": 0,
  "notes": "The five-step constitutional founding: cosmic address -> 19 reference-default constitution settings -> map data/ETL -> districts -> seat institutions, shown as its completed end-state, plus the restore-from-backup path. Reference defaults not locks (Art. VII); apportionment fires at the planet-scope Accept Map Data button (1,999 seats / 393 districts / 951,636 rows / 11.30 GB seed). DISTINCT from operator/setup.html (node/mesh provisioning). Lives in the Run-a-node act of the tour; setup-wizard.html merged into this page (now a redirect)."
 },
 {
  "file": "tour.html",
 ...
 {
  "file": "shared/bill.html",
  "title": "A bill — the conversation",
  "module": "shared",
  "nav": "bills",
  "interactionClass": "all",
  "journeys": [
  ...
  "status": "built-layer",
  "stage": 3,
  "notes": "One bill as a living conversation: what it changes in plain words, where it sits in the process, the discussion, and the redline negotiation. The full formal record lives at legislature/bill-detail.html."
 },
 {
 ...
 },
 {
  ...
  "status": "planned-layer",
  "stage": 2,
  "notes": "Personal balance + transactions; private — like a ballot, only you can read it; abstract units; F-IND-023 transfer."
 },
 {
 ...
 },
 {
  ...
  "status": "built-layer",
  "stage": 2,
  "notes": "The invite landing page — someone sent you a link into a room: see what it is, pick a name, and step in. The front door of the first minute."
 },
 {
 ...
 },
 {
  ...
  "status": "built-layer",
  "stage": "G",
  "notes": "DNS-before-cert; per-name primary + wildcard backup (gated/stub); DDNS; DNS providers (Cloudflare live, stubs); the LE budget pre-flight. Token write-only — never shown again after entry. services/mesh-cert-broker."
 },
 {
 ...
 },
 {
  ...
  "title": "Worker seats on the board",
  "module": "organizations",
  "roles": [
   "R-25",
   "R-27",
