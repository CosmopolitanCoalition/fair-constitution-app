...
Latest additional request: preserve **one public profile per person**, including every candidacy and recorded current/past office, with older public history reachable. The cutoff/past-office repair is now completed and internally tested; see [public history evidence](../2026-09-13/PERSON_PUBLIC_HISTORY.md). Its three concurrent indexes (130000 migration) are applied locally and valid. The candidacy panel loads only when opened, and history pages fetch only their own props. The remaining B6 work is explicitly candidacy standings/endorsement expansion inside this same profile. Counts remain 13/20 builds and 2/27 full reviews; do not count this extra request as a full B6 closure or repeat its finished history work.

EO-2 recurring elected offices and EO-3 institution filings are now integrated and closed. EO-4 confirmation/refusal/seating is integrated; player nomination remains open because its actor/body and judicial-committee designation are not defined by current code. See [integration evidence](../2026-09-13/INTEGRATION_AND_MAP_CLEANUP.md) and the remaining decision in [judicial appointments](../2026-09-13/JUDICIAL_APPOINTMENT_SURFACE.md). Fixed-baseline totals: **13 builds closed / 20 remaining; 2 full reviews closed / 27 remaining**. Use the active punch list, not older chronological counts below.
