...
| P2 | 1 | Finish treasury and long-history reads. | Seller pending orders now paginated; treasury and other histories remain | Treasury entry avoids world supply aggregation; wallet payments/stipends, seller pending orders and institution histories are paged with indexed scope and usable return paths. |
...
- B3/P2 still cover wallet payment and stipend histories (currently 50/12) and other long institution records. Seller pending orders now have 20-row cursors, exact seller/listing checks and first-page recovery after settlement. Treasury still has legacy aggregate paths; completing the money-report reader does not make those paths bounded automatically.
...
| Before civic rehearsal | B3/P2: older wallet/stipend/institution records and treasury reads | Still unfinished. Seller pending orders are now paginated; existing money-report and hiring pagination do not complete the other separate paths. |
