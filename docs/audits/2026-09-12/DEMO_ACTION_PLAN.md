...
| 2A. Institutional rooms | Make civic meetings usable and recognizable. | Core calls, floor controls and connected seating implemented; archives and rehearsal remain | Institution-specific calls, floor positions, names and reconnect behavior pass independent-participant checks. |
