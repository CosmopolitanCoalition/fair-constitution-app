...
### 29 (retired). Candidate profile — surface removed by operator ruling A4, 2026-07-29
The surface was removed from `config/cga/surfaces.php` on 2026-07-29; its copy moved to
`K2_RETIRED_candidate-profile.md` so the generator's surface-id cross-check runs clean.
Candidate self-description lives on the candidacy and open-ballot surfaces now.
