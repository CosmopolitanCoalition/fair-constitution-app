...
stamp = "As of %s · main @ <code>%s</code> · maps done · Wave 6 conference demo · 11 decisions ruled 2026-09-05, 3 open · screens/caps/debt corpus dated 2026-08-04" % (DATA['asOf'], DATA['head'])
