           ...
           {'id': 'W10',
            ...
            'items': [{'wave': 'W10',
                      ...
                      {'wave': 'W10',
                       ...
                       'status': 'done',
                       'note': 'SHIPPED 2026-09-10: 6486469d CGA_RESIDENCY_INSTANT (thresholdDays 0, F-IND-006 files at declare); 8a96c779 menu + sidebar never hide a section by role; 253847f0 board console + org economy render read-only for every viewer; 12c1c02b Residency page for the common user. The setup lock (RedirectIfSetupIncomplete) was the gate the operator felt on box E; closed by completeStep6 (box E setup_completed_at 2026-09-10).'},
                      {'wave': 'W10',
                       'label': "0c · The place page; the election page in the viewer's terms; desktop width",
                       'status': 'done',
