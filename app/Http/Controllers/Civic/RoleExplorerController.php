    ...
    public function __invoke(Request $request): Response
    {
        ...
        if ($place) {
            ...
            $destinations = [
                ...
                'chamber-room' => $legislature ? '/rooms/chamber/'.$legislature : null,
                'committee-rooms' => '/rooms?section=committees&jurisdiction='.$id,
                'court-rooms' => '/rooms?section=courts&jurisdiction='.$id,
                'sessions' => $legislature ? '/legislatures/'.$legislature.'/sessions' : null,
